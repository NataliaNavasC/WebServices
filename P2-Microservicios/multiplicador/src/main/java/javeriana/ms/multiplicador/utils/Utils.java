...
public class Utils {
    ...
    static final String filename = "MultiplicacionOperaciones.json";
    ...
    public static List<Operacion> loadData(){
        try {
            ...
            List<Operacion> operaciones = new ArrayList<Operacion>(Arrays.asList(gson.fromJson(reader,Operacion[].class)));
            reader.close();
            return operaciones;
        }
        catch (Exception e){
